...
export class AppComponent implements AfterViewInit {
  ...
  config = [
    ...
    },
    {
      ...
      options: [
        { valor: 1, label: 'Pizza' },
        { valor: 2, label: 'Cachorro Quente' },
        { valor: 3, label: 'Pão de Milho' },
        { valor: 4, label: 'Café' }
      ],
      validation: [Validators.required]
    }, {
  ...
  ngAfterViewInit() {
    console.log("app.component:ngAfterViewInit-form",this.form);
    console.log("app.component:ngAfterViewInit-config",this.config);
